...
class WearModelName(models.Model):
    ...
    wear_picture = models.ImageField(upload_to='wear_picture/', blank=True, null=True)
    wear_picture_credit = models.URLField(max_length=200, default='www.gadget4india.com')
...
class WearVariantImage(models.Model):
    ...
    wear_image = models.ImageField(upload_to='wear_image/', blank=True, null=True)
