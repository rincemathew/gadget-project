...
class EarModelName(models.Model):
    ...
    ear_picture = models.ImageField(upload_to='ear_picture/', blank=True, null=True)
    ear_picture_credit = models.URLField(max_length=200, default='https://www.gadget4india.com/aboutus/')
    ear_release_date = models.DateField(auto_now=False, auto_now_add=False, blank=True, null=True)
    ear_availability = models.BooleanField(default=False)
